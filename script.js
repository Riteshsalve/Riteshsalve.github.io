...
// *=============================== github calender ==================================
    GitHubCalendar(".calendar", "riteshsalve");

    // or enable responsive functionality:
    GitHubCalendar(".calendar", "riteshsalve", { responsive: true });
...
// *=============================== resume open in new tab ==================================
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1QyT7bB9KCFAzJ53ZiDCxPasrqgwsE2Bs/view?usp=sharing",
        "_blank"
      );
    }
